 ...
 * @author Javier
 */
public class FXMLExplorerGuardarBlockController implements Initializable {

    @FXML
    private TreeView tvArbol;
    @FXML
    private TilePane control;
    @FXML private TextField txtNombreB;
    @FXML private TextArea rutaGB;
    @FXML private ComboBox cmbExtesionesB;
     ...
     private void exploradorGB(){
        ...
        tvArbol.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                ...
                rutaGB.setText(ruta);
                //setRuta(ruta);         
                setIconFilesSaveB(selectedItem.getChildren());
