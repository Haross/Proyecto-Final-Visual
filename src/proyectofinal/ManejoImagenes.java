...
public class ManejoImagenes {
    ...
    public Image openFile() {
        fileDialog.setTitle("Abrir");
        fileDialog.setInitialDirectory(this.myPath);

        FileChooser.ExtensionFilter png = new FileChooser.ExtensionFilter("PNG Files", "*.png");
        FileChooser.ExtensionFilter jpg = new FileChooser.ExtensionFilter("JPG Files", "*.jpg");
        
        fileDialog.getExtensionFilters().addAll(png,jpg);
    ...
    public void saveAsImage(GraphicsContext gc) {
        ...
        FileChooser.ExtensionFilter jpgExt = new FileChooser.ExtensionFilter("JPG Files", "*.jpg");
        ...
        WritableImage image = new WritableImage(wd, hg);
         gimagen = canvas.snapshot(null, image);
        //RenderedImage imageFinal = SwingFXUtils.fromFXImage(image, null);
        //BufferedImage imageFinal = SwingFXUtils.fromFXImage(image, null);
    ...
    public WritableImage getImagen(){
        return gimagen;
    }
}
